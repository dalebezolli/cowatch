		...
		<Fragment>
			...
			<main className="relative text-center text-light font-medium">
				...
				<CenterContainer width="800" className="mt-[64px] mb-[256px] flex flex-col items-center gap-8">
					...
					<button className="mb-6 px-[2px] py-px cursor-pointer rounded-full bg-radial-[at_50%_100%] from-white to-[#79768B] shadow-2xl shadow-white/15">
...
function CenterContainer({ width="1920", className="", children}: PropsWithChildren<{
	width?: string;
	className?: string;
}>) {
	return (
